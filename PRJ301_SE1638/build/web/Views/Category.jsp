<%-- 
    Document   : Category
    Created on : Oct 17, 2022, 11:18:38 AM
    Author     : 84961
--%>

<%-- 
    Document   : LoadDB
    Created on : Oct 2, 2022, 9:54:38 PM
    Author     : 84961
--%>
    ...
    <body>
            ...
            <div class="header_account_cart">
               ...
               <div class="item_header_account_cart">
                ...
                <div class="item_header_account_cart">
                    Cart
                    <br>
                    <span href="cart.html">(ship toàn quốc)</span>
                </div>
            </div>
        </div>
        <div class="navbar">
        ...
        <div style="display: flex;flex-wrap: wrap;">   
            <c:forEach var ="pr" items="${dao.product}"> 
             ...
             <c:if test = '${sessionScope.account.manager == 1}'> 
            <div style="width:31.3%; padding: 10px 10px; text-align: center;margin: auto;width: fit-content">
                <a href="additem?cid=${cid}"><img src="images/add-product.png" alt="" height="50px" width="50px"></a></div>
                 </c:if>
        </div>
